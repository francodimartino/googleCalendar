...
class GoogleCalendarManager:
    ...
    def list_upcoming_events(self, max_results=10):
        ...
        tomorrow = (dt.datetime.now() + dt.timedelta(days=20)).replace(hour=23, minute=59, second=0, microsecond=0).isoformat() + "Z"
...
#calendar.create_event("ver que me cocino","2024-02-11T21:30:00-03:00","2024-02-11T22:00:00-03:00","America/Argentina/Catamarca",["francogdimartino@gmail.com"])

calendar.delete_event(event_id="p42sebmjjb1f4plqrnqiv0mq44")